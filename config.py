...
# Ключи без загруженного фото автоматически пропускаются в main.py.
...
PHOTO_MAPPING = {
    ...
    "волосы": {
        ...
        "Натуральные": [
            "biolipid_spray",        # шампунь/кондиционер укрепление нет отдельного ключа — ближайший аналог
            "strengthening_mask",
            "protein_cream",
        ],
        ...
        "Выпадение": [
            # шампунь против выпадения и лосьон — нет в базе фото, список пустой
        ],
        "Перхоть/зуд": [
            # шампунь против перхоти — нет в базе фото
        ],
        "Секущиеся кончики": [
            "oil_elixir",
        ],
        ...
        "чувствительная_кожа": [
            # шампунь для чувствительной кожи головы — нет в базе фото
        ],
        "объем": [
            "thin_hair_shampoo",
            "thin_hair_conditioner",
