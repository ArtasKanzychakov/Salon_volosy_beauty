...
PHOTO_STRUCTURE_ADMIN = {
    "💇‍♀️ Волосы": {
        ...
        "🎨 Для окрашенных волос": [
            ("colored_shampoo", "Шампунь для окрашенных волос"),  # ← НОВОЕ
            ("colored_conditioner", "Кондиционер для окрашенных"),
            ("colored_mask", "Маска для окрашенных"),
        ],
        "📈 Для тонких волос": [  # ← НОВАЯ подкатегория
        ...
        "✨ Маски и эликсиры": [
            ...
            ("strengthening_mask", "Укрепляющая маска для волос"),  # ← НОВОЕ
        ],
        "🔧 Восстановление": [
    ...
    "🧴 Тело": {
        ...
        "🚿 Очищение и скрабы": [
            ...
            ("perfumed_soap", "Парфюмерное мыло"),  # ← НОВОЕ
        ]
    }
}
...
PHOTO_MAPPING = {
    ...
    "волосы": {
        ...
        "Окрашенные": ["colored_shampoo", "colored_conditioner", "colored_mask"],  # ← добавлен colored_shampoo
        "Натуральные": [],
        "Ломкость": ["oil_elixir", "hair_fluid", "biolipid_spray", "protein_cream"],  # ← добавлен protein_cream
        "Выпадение": [],
        "Перхоть/зуд": [],
        "Секущиеся кончики": ["oil_elixir"],
        "Тусклость": ["hair_milk", "oil_concentrate"],
        "Пушистость": ["oil_elixir", "hair_fluid", "protein_cream", "hair_milk"],  # ← добавлен hair_milk
        "Тонкие": ["thin_hair_shampoo", "thin_hair_conditioner", "strengthening_mask"],  # ← НОВЫЕ продукты
        "Очень поврежденные": ["oil_elixir", "hair_fluid", "reconstruct_shampoo", "reconstruct_mask", "biolipid_spray", "strengthening_mask"],
        "чувствительная_кожа": [],
        "объем": [],  # ← Биолипидный спрей убран
...
PRODUCT_PRICES = {
    ...
    "body_scrub": "700₽",
    "shower_gel": "800₽",
    "perfumed_soap": "600₽",  # ← НОВОЕ
    
    # Волосы
    "blonde_shampoo": "900₽",
    "blonde_conditioner": "1200₽",
    "blonde_mask": "1500₽",
    "colored_shampoo": "900₽",  # ← НОВОЕ
    "colored_conditioner": "1200₽",
    "colored_mask": "1500₽",
    "thin_hair_shampoo": "900₽",  # ← НОВОЕ
    "thin_hair_conditioner": "1200₽",  # ← НОВОЕ
    ...
    "strengthening_mask": "1500₽",  # ← НОВОЕ
    "men_shampoo": "800₽",  # ← НОВОЕ
}
