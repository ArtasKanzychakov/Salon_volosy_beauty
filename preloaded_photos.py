...
PRELOADED_PHOTOS = {
    ...
    # ── ВОЛОСЫ — лечебный уход (новые ключи) ──────────────────────────────
    "anti_loss_shampoo":       "",   # ❌ НЕТ ФОТО — нужно: anti_loss_shampoo.jpg
    "hair_growth_lotion":      "",   # ❌ НЕТ ФОТО — нужно: hair_growth_lotion.jpg
    "anti_dandruff_shampoo":   "",   # ❌ НЕТ ФОТО — нужно: anti_dandruff_shampoo.jpg
    "sensitive_scalp_shampoo": "",   # ❌ НЕТ ФОТО — нужно: sensitive_scalp_shampoo.jpg
